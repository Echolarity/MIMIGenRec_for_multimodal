...
def main():
    ...
    # =============== 新增：提取并下发 CF Embeddings ==================
    cf_emb = best_model.item_embeddings.weight.detach().cpu().numpy()
    cf_emb_path = os.path.join(args.save_dir, "cf_emb.npy")
    np.save(cf_emb_path, cf_emb)
    # ===================================================================

    print(f"Saved to {args.save_dir}")
    print(f"✅ CF Embeddings generated securely at: {cf_emb_path}")
